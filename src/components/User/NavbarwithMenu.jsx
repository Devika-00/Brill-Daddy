                ...
                <div className="absolute top-24 left-0 bg-white w-64 h-full shadow-lg z-50">
                    <div className="p-4">
                        ...
                        <ul>
                            ...
                            <li className="p-2 hover:bg-gray-100 cursor-pointer">Fashion</li>
                            <li className="p-2 hover:bg-gray-100 cursor-pointer">Home & Furniture</li>
                            <li className="p-2 hover:bg-gray-100 cursor-pointer">Sports & Fitness</li>
                            <li className="p-2 hover:bg-gray-100 cursor-pointer">Beauty & Personal Care</li>
                        </ul>
                    </div>
                </div>
            )}
